...
TOKEN = "1798983094:AAGiQGsm7Y9sNu-kHGL1pzZw8avfxjf-PAA"
...
def download(bot, update):
    ...
    if instagram_post=="/start":
        ...
        update.message.reply_text("I can Download from Instagram 📥 just send me a link ch : @Sylix_Team", parse_mode=ParseMode.HTML, disable_web_page_preview=True)
    else:
        pass
